        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VariantCombination = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedValuesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVariantAttributeValues", x => new { x.ProductVariantId, x.SelectedValuesId });
                    table.ForeignKey(
                        name: "FK_ProductVariantAttributeValues_AttributeValues_SelectedValuesId",
                        column: x => x.SelectedValuesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantAttributeValues_SelectedValuesId",
                table: "ProductVariantAttributeValues",
                column: "SelectedValuesId");
